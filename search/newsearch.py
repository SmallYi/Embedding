...
class LSHAnalysis():
    ...
    def Mainfunc(self,mat_addr,base,result_folder,binary_file):
        ...
        #core 只针对DIR
        imodel_name = 'busybox_mips_o0'
        imodel_BIN_name = 'busybox_mips_o0'
        ...
        itest_name = 'busybox_x86_o0'
        itest_BIN_name = 'busybox_x86_o0'
    ...
    #    output_total = open(result_folder + 'result_total.txt', 'w')
        ...
        if (Inmodel_NUM/Inmodel_Total)>1:
            res=str(float('%.4f' % (Inmodel_NUM/(len(itest_func_list)))))
            Inmodel_NUM=(Inmodel_NUM/(len(itest_func_list)))*Inmodel_Total
